...
public class UserServiceImpl extends BaseOpenmrsService implements UserService {
	 ...
	 */
	@Override
	public void changePasswordUsingActivationKey(String activationKey, String /**
													  * This Source Code Form is subject to the terms of the Mozilla Public License,
													  * v. 2.0. If a copy of the MPL was not distributed with this file, You can
													  * obtain one at http://mozilla.org/MPL/2.0/. OpenMRS is also distributed under
													  * the terms of the Healthcare Disclaimer located at http://openmrs.org/license.
...
import java.util.stream.Collectors;
	...
	public class UserServiceImpl extends BaseOpenmrsService implements UserService {
		...
		private static final Logger log = LoggerFactory.getLogger(org.openmrs.api.impl.UserServiceImpl.class);
...
//	@Override
//	public	User getUserById(Integer userId, Integer tenantId){
//		return dao.findByUserIdAndTenantId(userId, tenantId);
//	}
//	@Override
//	public List<User> getUserByTenantId(Integer tenantId) {
